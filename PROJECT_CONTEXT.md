...
**PENDING ⬜**
- m25–m36 (rest of Part 3 ML [m25–m28], Part 4 LLM [m29–m34], Part 5 capstone [m35–m36]). Build **on the
  learner's signal** ("Module 25", etc.), one at a time, in depth. NOTE: Part 3 is where his AI/ML
